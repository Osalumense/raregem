                ...
                <div class="flex justify-between mb-6">
                    <div>
                        <div class="flex items-center mb-1">
                            ...
                            <div class="p-1 rounded bg-emerald-500/10 text-emerald-500 text-[12px] font-semibold leading-none ml-2">+30% this month</div>
                        </div>
                ...
                <div class="flex justify-between mb-4">
                    <div>
                        <div class="flex items-center mb-1">
                            ...
                            <div class="p-1 rounded bg-red-500/10 text-red-500 text-[12px] font-semibold leading-none ml-2">-30% this month</div>
                        </div>
                        <div class="text-sm font-medium text-gray-400">Sales</div>
                    </div>
                    <div class="dropdown">
                        <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
                        <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
            ...
            <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                <div class="flex justify-between mb-6">
                    <div>
                        ...
                        <div class="text-sm font-medium text-gray-400">Orders Processed</div>
                    </div>
                    <div class="dropdown">
                        <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
                        <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div class="p-6 relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 w-full shadow-lg rounded">
                ...
                <div class="flex flex-wrap items-center px-4 py-2">
                    ...
                    <h3 class="font-semibold text-base text-gray-900">Transactions</h3>
                    </div>
                </div>
                <div class="block w-full overflow-x-auto">
                    ...
                    <thead>
                        <tr>
                        <th class="px-4 bg-gray-100 text-gray-500 align-middle border border-solid border-gray-200 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Customer</th>
                        <th class="px-4 bg-gray-100 text-gray-500 align-middle border border-solid border-gray-200 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Amount</th>
                        <th class="px-4 bg-gray-100 text-gray-500 align-middle border border-solid border-gray-200 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left min-w-140-px">Status</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                            <div class="flex">
                                <div class="px-4 py-1 rounded text-red-500 text-small font-semibold leading-none ml-2">Failed</div>
                            </div>
                        </td>
                        </tr>
                        <tr class="text-gray-700">
                        ...
                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                            <div class="flex">
                                <div class="px-4 py-1 rounded text-emerald-500 text-small font-semibold leading-none ml-2">Success</div>
                            </div>
                            </div>
                        </td>
                        </tr>
